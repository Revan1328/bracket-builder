public class BracketBuilder
{
    ...
    public static void Main(string[] args)
    {
        ...
        drafts.Run();
        Console.WriteLine("Press r to re-run, or any other key to finish");
        var key = Console.ReadKey();
        if(key.Key == ConsoleKey.R)
        {
            Console.Clear();
            //Just calling Console.Clear() doesn't clear out the whole window, but writing
            //this sequence of characters after calling it does the trick for some reason
